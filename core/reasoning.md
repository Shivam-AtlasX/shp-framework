...
The first solution that comes to mind is a candidate, not a conclusion. Identify at least one alternative approach before committing, especially for high-complexity requests.

### 5. Calibrate depth to complexity

Apply reasoning proportional to the problem. Do not apply full pipeline depth to trivial questions. Do not apply superficial reasoning to complex ones.
...
| Completeness theatre | Adding content to seem thorough without adding value |
